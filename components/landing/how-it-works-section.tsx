                ...
                {steps.map((item, index) => {
                  ...
                  return (
                    <article
                      ...
                      className={cn(
                        "how-it-works-step-card group motion-card-hover relative box-border cursor-pointer border border-[#f1ece9] px-6 pb-7 pt-8 text-center shadow-md md:shadow-[0_12px_24px_rgba(31,27,24,0.10)] md:px-6 md:pb-8 md:pt-9",
